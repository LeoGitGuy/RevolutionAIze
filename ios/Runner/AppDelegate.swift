...
@objc class AppDelegate: FlutterAppDelegate {
    override func application(
        ...
        let sharedSuiteName: String = "group.com.example.articleReader"
        let sharedDataKey: String = "SharedData"
        
        let controller: FlutterViewController = window?.rootViewController as! FlutterViewController
        let methodChannel = FlutterMethodChannel(name: "com.example.articleReader", binaryMessenger: controller.binaryMessenger)
